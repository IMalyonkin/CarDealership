...
namespace CarDealership
{
    public class logInVM : INotifyPropertyChanged
    {
        ...
        private void findEmp()
        {
            ...
            if (employees.FirstOrDefault() != null && employees.FirstOrDefault().Role == "Сотрудник")
            {
                MainWindow mainWindow = new MainWindow(employees.FirstOrDefault());
                logInWindow.Close();
                mainWindow.Show();
            }
            else if (employees.FirstOrDefault() != null && employees.FirstOrDefault().Role == "Администратор")
            {

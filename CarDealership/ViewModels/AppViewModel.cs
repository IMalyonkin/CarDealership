...
namespace CarDealership
{
    ...
    {
        VehiclesInStockPage vehiclesInStockPage;
        MainWindow window;
        Frame main;
        ...
        public VehiclesInStockPage VehiclesInStockPage
        {
            get { return vehiclesInStockPage; }
            set { vehiclesInStockPage = value; }
        }
        ...
        public RelayCommand Contract
        {
            get
            {
                return contract ??
                  ...
                  {
                      main.Content = new ContractPage(this, selectedVehicle);
                      window.hideSideBar();                      
                  }, 
                  obj => selectedVehicle != null));
            }
        }

        public AppViewModel(Frame main, MainWindow window, VehiclesInStockPage vehiclesInStockPage)
        {
            this.vehiclesInStockPage = vehiclesInStockPage;
            this.window = window;
            this.main = main;
            db = new CarsContext();
